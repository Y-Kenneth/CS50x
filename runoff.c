...
// Track voter, rank, name. Loop through candidate and compare to name - If name match, then update vote count
bool vote(int voter, int rank, string name)
{
    for (int i = 0; i < candidate_count; i++)
    {
...
// Tabulate votes for non-eliminated candidates. Update number of votes not eliminated.
